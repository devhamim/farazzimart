                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row" style="padding: 6px 0;">
                                        <label for="discount" class="offset-md-6 col-md-2 col-form-label text-right">Discount</label>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" id="discount" min="0" name="discount" value="0.00">
                                        </div>
                                    </div>
    ...
    $(document).ready(function () {
        $('#product').on('change', function () {
            ...
            $.ajax({
                ...
                data: {_token: CSRF_TOKEN, id: $(this).val()},
                success: function (data) {
                    // Assuming data is an object containing SKU, Product Name, quantity, and Price
                    var newRowHtml = '<tr>' +
                        '<td>' + data.sku + '</td>' +
                        '<td>' + data.productName + '</td>' +
                        '<td><input style="width: 60px;border: 1px solid #ddd;" min="1" type="number" class="form-control qty" name="quantity[]" value="1"><input type="hidden" name="price[]" class="price" value="' + data.product_price + '"></td>' +
                        '<td class="total_price">' + (data.product_price * 1).toFixed(2) + '</td>' +
